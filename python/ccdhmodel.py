...
# Generation date: 2021-05-24 13:05
# Schema: CRDC-H
#
...
class CancerGrade(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.method_type is None:
            raise ValueError("method_type must be supplied")
        if not isinstance(self.method_type, str):
            self.method_type = str(self.method_type)

        if self.observations is not None and not isinstance(self.observations, str):
            self.observations = str(self.observations)

        super().__post_init__(**kwargs)


@dataclass
class CancerStage(YAMLRoot):
    """
    ...
    valueCodeableConcept: Optional[str] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.valueCodeableConcept is not None and not isinstance(self.valueCodeableConcept, str):
            self.valueCodeableConcept = str(self.valueCodeableConcept)

        super().__post_init__(**kwargs)


@dataclass
class CancerStageSet(YAMLRoot):
    """
    ...
    observations: Optional[Union[str, List[str]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.observations = [v if isinstance(v, str) else str(v) for v in self.observations]
...
class CodeableConcept(YAMLRoot):
    ...
    coding: Optional[Union[str, List[str]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.coding = [v if isinstance(v, str) else str(v) for v in self.coding]
...
class SpecimenContainer(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.container_number is not None and not isinstance(self.container_number, str):
            self.container_number = str(self.container_number)
...
class Diagnosis(YAMLRoot):
    ...
    year_at_diagnosis: Optional[str] = None
    condition: Optional[str] = None
    primary_site: Optional[Union[str, List[str]]] = empty_list()
    metastatic_sites: Optional[Union[str, List[str]]] = empty_list()
    stage: Optional[Union[str, List[str]]] = empty_list()
    grade: Optional[Union[str, List[str]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.year_at_diagnosis is not None and not isinstance(self.year_at_diagnosis, str):
            self.year_at_diagnosis = str(self.year_at_diagnosis)
        ...
        self.primary_site = [v if isinstance(v, str) else str(v) for v in self.primary_site]
        ...
        self.metastatic_sites = [v if isinstance(v, str) else str(v) for v in self.metastatic_sites]

        if self.stage is None:
            self.stage = []
        if not isinstance(self.stage, list):
            self.stage = [self.stage]
        self.stage = [v if isinstance(v, str) else str(v) for v in self.stage]

        if self.grade is None:
            self.grade = []
        if not isinstance(self.grade, list):
            self.grade = [self.grade]
        self.grade = [v if isinstance(v, str) else str(v) for v in self.grade]

        if self.morphology is not None and not isinstance(self.morphology, str):
            self.morphology = str(self.morphology)

        if self.disease_status is not None and not isinstance(self.disease_status, str):
            self.disease_status = str(self.disease_status)

        if self.prior_diagnosis is not None and not isinstance(self.prior_diagnosis, str):
            self.prior_diagnosis = str(self.prior_diagnosis)

        if self.method_of_diagnosis is not None and not isinstance(self.method_of_diagnosis, str):
...
class Document(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.document_type is not None and not isinstance(self.document_type, str):
            self.document_type = str(self.document_type)
...
class ResearchSubject(YAMLRoot):
    ...
    id: str = None
    associated_subject: str = None
    identifier: Optional[Union[str, List[str]]] = empty_list()
    description: Optional[str] = None
    member_of_research_project: Optional[Union[str, List[str]]] = empty_list()
    age_at_enrollment: Optional[str] = None
    primary_diagnosis_condition: Optional[str] = None
    primary_diagnosis_site: Optional[str] = None
    primary_diagnosis: Optional[Union[str, List[str]]] = empty_list()
    comorbid_diagnoses: Optional[Union[str, List[str]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.associated_subject, str):
            self.associated_subject = str(self.associated_subject)
        ...
        self.member_of_research_project = [v if isinstance(v, str) else str(v) for v in self.member_of_research_project]

        if self.age_at_enrollment is not None and not isinstance(self.age_at_enrollment, str):
            self.age_at_enrollment = str(self.age_at_enrollment)

        if self.primary_diagnosis_condition is not None and not isinstance(self.primary_diagnosis_condition, str):
            self.primary_diagnosis_condition = str(self.primary_diagnosis_condition)

        if self.primary_diagnosis_site is not None and not isinstance(self.primary_diagnosis_site, str):
            self.primary_diagnosis_site = str(self.primary_diagnosis_site)
        ...
        self.primary_diagnosis = [v if isinstance(v, str) else str(v) for v in self.primary_diagnosis]
        ...
        self.comorbid_diagnoses = [v if isinstance(v, str) else str(v) for v in self.comorbid_diagnoses]
...
class Specimen(YAMLRoot):
    ...
    preinvasive_tissue_morphology: Optional[str] = None
    morphology_pathologically_confirmed: Optional[str] = None
    morphology_assessor_role: Optional[str] = None
    morphlogy_assessment_method: Optional[str] = None
    degree_of_dysplasia: Optional[str] = None
    dysplasia_fraction: Optional[str] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.source_subject is not None and not isinstance(self.source_subject, str):
            self.source_subject = str(self.source_subject)
        ...
        if self.preinvasive_tissue_morphology is not None and not isinstance(self.preinvasive_tissue_morphology, str):
            self.preinvasive_tissue_morphology = str(self.preinvasive_tissue_morphology)
        ...
        if self.morphology_assessor_role is not None and not isinstance(self.morphology_assessor_role, str):
            self.morphology_assessor_role = str(self.morphology_assessor_role)

        if self.morphlogy_assessment_method is not None and not isinstance(self.morphlogy_assessment_method, str):
            self.morphlogy_assessment_method = str(self.morphlogy_assessment_method)
        ...
        if self.dysplasia_fraction is not None and not isinstance(self.dysplasia_fraction, str):
            self.dysplasia_fraction = str(self.dysplasia_fraction)
...
class SpecimenCreationActivity(YAMLRoot):
    ...
    derivation_method_type: Optional[str] = None
    additive: Optional[Union[str, List[str]]] = empty_list()
    ...
    specimen_order: Optional[str] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.collection_method_type is not None and not isinstance(self.collection_method_type, str):
            self.collection_method_type = str(self.collection_method_type)

        if self.derivation_method_type is not None and not isinstance(self.derivation_method_type, str):
            self.derivation_method_type = str(self.derivation_method_type)
        ...
        if self.specimen_order is not None and not isinstance(self.specimen_order, str):
            self.specimen_order = str(self.specimen_order)
...
class SpecimenProcessingActivity(YAMLRoot):
    ...
    executionConditions: Optional[Union[str, List[str]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.executionConditions = [v if isinstance(v, str) else str(v) for v in self.executionConditions]
...
class SpecimenStorageActivity(YAMLRoot):
    ...
    date_ended: Optional[str] = None
    method_type: Optional[str] = None
    container: Optional[Union[str, List[str]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.container = [v if isinstance(v, str) else str(v) for v in self.container]

        super().__post_init__(**kwargs)


@dataclass
class SpecimenTransportActivity(YAMLRoot):
    """
...
class Subject(YAMLRoot):
    ...
    race: Optional[Union[str, List[str]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.race, list):
            self.race = [self.race]
        self.race = [v if isinstance(v, str) else str(v) for v in self.race]
        ...
        if self.age_at_death is not None and not isinstance(self.age_at_death, str):
            self.age_at_death = str(self.age_at_death)

        if self.year_of_death is not None and not isinstance(self.year_of_death, str):
            self.year_of_death = str(self.year_of_death)
...
class TimePoint(YAMLRoot):
    ...
    indexDate: Optional[str] = None
    indexEventType: Optional[str] = None
    offsetFromIndex_indexOffset: Optional[str] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.dateTime is not None and not isinstance(self.dateTime, str):
            self.dateTime = str(self.dateTime)

        if self.indexDate is not None and not isinstance(self.indexDate, str):
            self.indexDate = str(self.indexDate)

        if self.indexEventType is not None and not isinstance(self.indexEventType, str):
            self.indexEventType = str(self.indexEventType)

        if self.offsetFromIndex_indexOffset is not None and not isinstance(self.offsetFromIndex_indexOffset, str):
            self.offsetFromIndex_indexOffset = str(self.offsetFromIndex_indexOffset)
...
class TimePeriod(YAMLRoot):
    ...
    periodStart_start: Optional[str] = None
    periodEnd_end: Optional[str] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.periodStart_start is not None and not isinstance(self.periodStart_start, str):
            self.periodStart_start = str(self.periodStart_start)

        if self.periodEnd_end is not None and not isinstance(self.periodEnd_end, str):
            self.periodEnd_end = str(self.periodEnd_end)
...
slots.biologicallyDerivedProduct__id = Slot(uri=CCDH.id, name="biologicallyDerivedProduct__id", curie=CCDH.curie('id'),
                   model_uri=CCDH.biologicallyDerivedProduct__id, domain=None, range=Optional[str])
...
slots.biologicallyDerivedProduct__description = Slot(uri=CCDH.description, name="biologicallyDerivedProduct__description", curie=CCDH.curie('description'),
                   model_uri=CCDH.biologicallyDerivedProduct__description, domain=None, range=Optional[str])
...
slots.biologicallyDerivedProduct__product_type = Slot(uri=CCDH.product_type, name="biologicallyDerivedProduct__product_type", curie=CCDH.curie('product_type'),
                   model_uri=CCDH.biologicallyDerivedProduct__product_type, domain=None, range=Optional[str])
...
slots.biologicallyDerivedProduct__passage_number = Slot(uri=CCDH.passage_number, name="biologicallyDerivedProduct__passage_number", curie=CCDH.curie('passage_number'),
                   model_uri=CCDH.biologicallyDerivedProduct__passage_number, domain=None, range=Optional[Union[str, List[str]]])
...
slots.cancerStage__observation_type = Slot(uri=CCDH.observation_type, name="cancerStage__observation_type", curie=CCDH.curie('observation_type'),
                   model_uri=CCDH.cancerStage__observation_type, domain=None, range=str)
...
slots.cancerStage__valueCodeableConcept = Slot(uri=CCDH.valueCodeableConcept, name="cancerStage__valueCodeableConcept", curie=CCDH.curie('valueCodeableConcept'),
                   model_uri=CCDH.cancerStage__valueCodeableConcept, domain=None, range=Optional[str])
...
slots.cancerStageSet__method_type = Slot(uri=CCDH.method_type, name="cancerStageSet__method_type", curie=CCDH.curie('method_type'),
                   model_uri=CCDH.cancerStageSet__method_type, domain=None, range=Optional[str])
...
slots.cancerStageSet__observations = Slot(uri=CCDH.observations, name="cancerStageSet__observations", curie=CCDH.curie('observations'),
                   model_uri=CCDH.cancerStageSet__observations, domain=None, range=Optional[Union[str, List[str]]])

slots.codeableConcept__coding = Slot(uri=CCDH.coding, name="codeableConcept__coding", curie=CCDH.curie('coding'),
                   model_uri=CCDH.codeableConcept__coding, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenContainer__identifier = Slot(uri=CCDH.identifier, name="specimenContainer__identifier", curie=CCDH.curie('identifier'),
                   model_uri=CCDH.specimenContainer__identifier, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenContainer__container_type = Slot(uri=CCDH.container_type, name="specimenContainer__container_type", curie=CCDH.curie('container_type'),
                   model_uri=CCDH.specimenContainer__container_type, domain=None, range=Optional[str])
...
slots.specimenContainer__container_number = Slot(uri=CCDH.container_number, name="specimenContainer__container_number", curie=CCDH.curie('container_number'),
                   model_uri=CCDH.specimenContainer__container_number, domain=None, range=Optional[str])

slots.specimenContainer__additive = Slot(uri=CCDH.additive, name="specimenContainer__additive", curie=CCDH.curie('additive'),
                   model_uri=CCDH.specimenContainer__additive, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenContainer__parent_container = Slot(uri=CCDH.parent_container, name="specimenContainer__parent_container", curie=CCDH.curie('parent_container'),
                   model_uri=CCDH.specimenContainer__parent_container, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenContainer__charge_type = Slot(uri=CCDH.charge_type, name="specimenContainer__charge_type", curie=CCDH.curie('charge_type'),
                   model_uri=CCDH.specimenContainer__charge_type, domain=None, range=Optional[str])

slots.diagnosis__id = Slot(uri=CCDH.id, name="diagnosis__id", curie=CCDH.curie('id'),
                   model_uri=CCDH.diagnosis__id, domain=None, range=Optional[str])

slots.diagnosis__identifier = Slot(uri=CCDH.identifier, name="diagnosis__identifier", curie=CCDH.curie('identifier'),
                   model_uri=CCDH.diagnosis__identifier, domain=None, range=Optional[Union[str, List[str]]])
...
slots.diagnosis__age_at_diagnosis = Slot(uri=CCDH.age_at_diagnosis, name="diagnosis__age_at_diagnosis", curie=CCDH.curie('age_at_diagnosis'),
                   model_uri=CCDH.diagnosis__age_at_diagnosis, domain=None, range=Optional[str])
...
slots.diagnosis__year_at_diagnosis = Slot(uri=CCDH.year_at_diagnosis, name="diagnosis__year_at_diagnosis", curie=CCDH.curie('year_at_diagnosis'),
                   model_uri=CCDH.diagnosis__year_at_diagnosis, domain=None, range=Optional[str])

slots.diagnosis__condition = Slot(uri=CCDH.condition, name="diagnosis__condition", curie=CCDH.curie('condition'),
                   model_uri=CCDH.diagnosis__condition, domain=None, range=Optional[str])

slots.diagnosis__primary_site = Slot(uri=CCDH.primary_site, name="diagnosis__primary_site", curie=CCDH.curie('primary_site'),
                   model_uri=CCDH.diagnosis__primary_site, domain=None, range=Optional[Union[str, List[str]]])
...
slots.diagnosis__metastatic_sites = Slot(uri=CCDH.metastatic_sites, name="diagnosis__metastatic_sites", curie=CCDH.curie('metastatic_sites'),
                   model_uri=CCDH.diagnosis__metastatic_sites, domain=None, range=Optional[Union[str, List[str]]])

slots.diagnosis__stage = Slot(uri=CCDH.stage, name="diagnosis__stage", curie=CCDH.curie('stage'),
                   model_uri=CCDH.diagnosis__stage, domain=None, range=Optional[Union[str, List[str]]])

slots.diagnosis__grade = Slot(uri=CCDH.grade, name="diagnosis__grade", curie=CCDH.curie('grade'),
                   model_uri=CCDH.diagnosis__grade, domain=None, range=Optional[Union[str, List[str]]])

slots.diagnosis__morphology = Slot(uri=CCDH.morphology, name="diagnosis__morphology", curie=CCDH.curie('morphology'),
                   model_uri=CCDH.diagnosis__morphology, domain=None, range=Optional[str])
...
slots.diagnosis__disease_status = Slot(uri=CCDH.disease_status, name="diagnosis__disease_status", curie=CCDH.curie('disease_status'),
                   model_uri=CCDH.diagnosis__disease_status, domain=None, range=Optional[str])
...
slots.diagnosis__prior_diagnosis = Slot(uri=CCDH.prior_diagnosis, name="diagnosis__prior_diagnosis", curie=CCDH.curie('prior_diagnosis'),
                   model_uri=CCDH.diagnosis__prior_diagnosis, domain=None, range=Optional[str])
...
slots.diagnosis__method_of_diagnosis = Slot(uri=CCDH.method_of_diagnosis, name="diagnosis__method_of_diagnosis", curie=CCDH.curie('method_of_diagnosis'),
                   model_uri=CCDH.diagnosis__method_of_diagnosis, domain=None, range=Optional[str])
...
slots.exposure__related_patient = Slot(uri=CCDH.related_patient, name="exposure__related_patient", curie=CCDH.curie('related_patient'),
                   model_uri=CCDH.exposure__related_patient, domain=None, range=Optional[str])

slots.identifier__value = Slot(uri=CCDH.value, name="identifier__value", curie=CCDH.curie('value'),
                   model_uri=CCDH.identifier__value, domain=None, range=str)
...
slots.researchProject__name_shortened = Slot(uri=CCDH.name_shortened, name="researchProject__name_shortened", curie=CCDH.curie('name_shortened'),
                   model_uri=CCDH.researchProject__name_shortened, domain=None, range=Optional[str])
...
slots.researchProject__description = Slot(uri=CCDH.description, name="researchProject__description", curie=CCDH.curie('description'),
                   model_uri=CCDH.researchProject__description, domain=None, range=Optional[str])
...
slots.researchProject__description_shortened = Slot(uri=CCDH.description_shortened, name="researchProject__description_shortened", curie=CCDH.curie('description_shortened'),
                   model_uri=CCDH.researchProject__description_shortened, domain=None, range=Optional[str])

slots.researchProject__sponsor = Slot(uri=CCDH.sponsor, name="researchProject__sponsor", curie=CCDH.curie('sponsor'),
                   model_uri=CCDH.researchProject__sponsor, domain=None, range=Optional[Union[str, List[str]]])
...
slots.researchProject__date_started = Slot(uri=CCDH.date_started, name="researchProject__date_started", curie=CCDH.curie('date_started'),
                   model_uri=CCDH.researchProject__date_started, domain=None, range=Optional[str])

slots.researchProject__date_ended = Slot(uri=CCDH.date_ended, name="researchProject__date_ended", curie=CCDH.curie('date_ended'),
                   model_uri=CCDH.researchProject__date_ended, domain=None, range=Optional[str])
...
slots.researchProject__primary_anatomic_site = Slot(uri=CCDH.primary_anatomic_site, name="researchProject__primary_anatomic_site", curie=CCDH.curie('primary_anatomic_site'),
                   model_uri=CCDH.researchProject__primary_anatomic_site, domain=None, range=Optional[Union[str, List[str]]])

slots.researchProject__url = Slot(uri=CCDH.url, name="researchProject__url", curie=CCDH.curie('url'),
                   model_uri=CCDH.researchProject__url, domain=None, range=Optional[Union[str, List[str]]])

slots.researchProject__part_of = Slot(uri=CCDH.part_of, name="researchProject__part_of", curie=CCDH.curie('part_of'),
                   model_uri=CCDH.researchProject__part_of, domain=None, range=Optional[Union[str, List[str]]])
...
slots.researchProject__research_project_type = Slot(uri=CCDH.research_project_type, name="researchProject__research_project_type", curie=CCDH.curie('research_project_type'),
                   model_uri=CCDH.researchProject__research_project_type, domain=None, range=str)
...
slots.researchProject__date_iacuc_approval = Slot(uri=CCDH.date_iacuc_approval, name="researchProject__date_iacuc_approval", curie=CCDH.curie('date_iacuc_approval'),
                   model_uri=CCDH.researchProject__date_iacuc_approval, domain=None, range=Optional[str])

slots.researchSubject__id = Slot(uri=CCDH.id, name="researchSubject__id", curie=CCDH.curie('id'),
                   model_uri=CCDH.researchSubject__id, domain=None, range=str)

slots.researchSubject__identifier = Slot(uri=CCDH.identifier, name="researchSubject__identifier", curie=CCDH.curie('identifier'),
                   model_uri=CCDH.researchSubject__identifier, domain=None, range=Optional[Union[str, List[str]]])
...
slots.researchSubject__description = Slot(uri=CCDH.description, name="researchSubject__description", curie=CCDH.curie('description'),
                   model_uri=CCDH.researchSubject__description, domain=None, range=Optional[str])
...
slots.researchSubject__member_of_research_project = Slot(uri=CCDH.member_of_research_project, name="researchSubject__member_of_research_project", curie=CCDH.curie('member_of_research_project'),
                   model_uri=CCDH.researchSubject__member_of_research_project, domain=None, range=Optional[Union[str, List[str]]])
...
slots.researchSubject__age_at_enrollment = Slot(uri=CCDH.age_at_enrollment, name="researchSubject__age_at_enrollment", curie=CCDH.curie('age_at_enrollment'),
                   model_uri=CCDH.researchSubject__age_at_enrollment, domain=None, range=Optional[str])
...
slots.researchSubject__primary_diagnosis_condition = Slot(uri=CCDH.primary_diagnosis_condition, name="researchSubject__primary_diagnosis_condition", curie=CCDH.curie('primary_diagnosis_condition'),
                   model_uri=CCDH.researchSubject__primary_diagnosis_condition, domain=None, range=Optional[str])
...
slots.researchSubject__primary_diagnosis_site = Slot(uri=CCDH.primary_diagnosis_site, name="researchSubject__primary_diagnosis_site", curie=CCDH.curie('primary_diagnosis_site'),
                   model_uri=CCDH.researchSubject__primary_diagnosis_site, domain=None, range=Optional[str])
...
slots.researchSubject__primary_diagnosis = Slot(uri=CCDH.primary_diagnosis, name="researchSubject__primary_diagnosis", curie=CCDH.curie('primary_diagnosis'),
                   model_uri=CCDH.researchSubject__primary_diagnosis, domain=None, range=Optional[Union[str, List[str]]])
...
slots.researchSubject__comorbid_diagnoses = Slot(uri=CCDH.comorbid_diagnoses, name="researchSubject__comorbid_diagnoses", curie=CCDH.curie('comorbid_diagnoses'),
                   model_uri=CCDH.researchSubject__comorbid_diagnoses, domain=None, range=Optional[Union[str, List[str]]])
...
slots.researchSubject__index_timepoint = Slot(uri=CCDH.index_timepoint, name="researchSubject__index_timepoint", curie=CCDH.curie('index_timepoint'),
                   model_uri=CCDH.researchSubject__index_timepoint, domain=None, range=Optional[str])
...
slots.researchSubject__originating_site = Slot(uri=CCDH.originating_site, name="researchSubject__originating_site", curie=CCDH.curie('originating_site'),
                   model_uri=CCDH.researchSubject__originating_site, domain=None, range=Optional[str])
...
slots.specimen__associated_project = Slot(uri=CCDH.associated_project, name="specimen__associated_project", curie=CCDH.curie('associated_project'),
                   model_uri=CCDH.specimen__associated_project, domain=None, range=Optional[str])

slots.specimen__data_provider = Slot(uri=CCDH.data_provider, name="specimen__data_provider", curie=CCDH.curie('data_provider'),
                   model_uri=CCDH.specimen__data_provider, domain=None, range=Optional[str])
...
slots.specimen__source_material_type = Slot(uri=CCDH.source_material_type, name="specimen__source_material_type", curie=CCDH.curie('source_material_type'),
                   model_uri=CCDH.specimen__source_material_type, domain=None, range=Optional[str])
...
slots.specimen__parent_specimen = Slot(uri=CCDH.parent_specimen, name="specimen__parent_specimen", curie=CCDH.curie('parent_specimen'),
                   model_uri=CCDH.specimen__parent_specimen, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimen__source_subject = Slot(uri=CCDH.source_subject, name="specimen__source_subject", curie=CCDH.curie('source_subject'),
                   model_uri=CCDH.specimen__source_subject, domain=None, range=Optional[str])
...
slots.specimen__source_model_system = Slot(uri=CCDH.source_model_system, name="specimen__source_model_system", curie=CCDH.curie('source_model_system'),
                   model_uri=CCDH.specimen__source_model_system, domain=None, range=Optional[str])
...
slots.specimen__condition_status_at_collection = Slot(uri=CCDH.condition_status_at_collection, name="specimen__condition_status_at_collection", curie=CCDH.curie('condition_status_at_collection'),
                   model_uri=CCDH.specimen__condition_status_at_collection, domain=None, range=Optional[str])
...
slots.specimen__creation_activity = Slot(uri=CCDH.creation_activity, name="specimen__creation_activity", curie=CCDH.curie('creation_activity'),
                   model_uri=CCDH.specimen__creation_activity, domain=None, range=Optional[str])
...
slots.specimen__processing_activity = Slot(uri=CCDH.processing_activity, name="specimen__processing_activity", curie=CCDH.curie('processing_activity'),
                   model_uri=CCDH.specimen__processing_activity, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimen__storage_activity = Slot(uri=CCDH.storage_activity, name="specimen__storage_activity", curie=CCDH.curie('storage_activity'),
                   model_uri=CCDH.specimen__storage_activity, domain=None, range=Optional[str])
...
slots.specimen__transport_activity = Slot(uri=CCDH.transport_activity, name="specimen__transport_activity", curie=CCDH.curie('transport_activity'),
                   model_uri=CCDH.specimen__transport_activity, domain=None, range=Optional[str])

slots.specimen__contained_in = Slot(uri=CCDH.contained_in, name="specimen__contained_in", curie=CCDH.curie('contained_in'),
                   model_uri=CCDH.specimen__contained_in, domain=None, range=Optional[str])
...
slots.specimen__dimensional_measure = Slot(uri=CCDH.dimensional_measure, name="specimen__dimensional_measure", curie=CCDH.curie('dimensional_measure'),
                   model_uri=CCDH.specimen__dimensional_measure, domain=None, range=Optional[str])
...
slots.specimen__quantity_measure = Slot(uri=CCDH.quantity_measure, name="specimen__quantity_measure", curie=CCDH.curie('quantity_measure'),
                   model_uri=CCDH.specimen__quantity_measure, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimen__quality_measure = Slot(uri=CCDH.quality_measure, name="specimen__quality_measure", curie=CCDH.curie('quality_measure'),
                   model_uri=CCDH.specimen__quality_measure, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimen__cellular_composition_type = Slot(uri=CCDH.cellular_composition_type, name="specimen__cellular_composition_type", curie=CCDH.curie('cellular_composition_type'),
                   model_uri=CCDH.specimen__cellular_composition_type, domain=None, range=Optional[str])
...
slots.specimen__cellular_composition_measure = Slot(uri=CCDH.cellular_composition_measure, name="specimen__cellular_composition_measure", curie=CCDH.curie('cellular_composition_measure'),
                   model_uri=CCDH.specimen__cellular_composition_measure, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimen__tissue_composition_measure = Slot(uri=CCDH.tissue_composition_measure, name="specimen__tissue_composition_measure", curie=CCDH.curie('tissue_composition_measure'),
                   model_uri=CCDH.specimen__tissue_composition_measure, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimen__general_tissue_morphology = Slot(uri=CCDH.general_tissue_morphology, name="specimen__general_tissue_morphology", curie=CCDH.curie('general_tissue_morphology'),
                   model_uri=CCDH.specimen__general_tissue_morphology, domain=None, range=Optional[str])
...
slots.specimen__specific_tissue_morphology = Slot(uri=CCDH.specific_tissue_morphology, name="specimen__specific_tissue_morphology", curie=CCDH.curie('specific_tissue_morphology'),
                   model_uri=CCDH.specimen__specific_tissue_morphology, domain=None, range=Optional[str])
...
slots.specimen__preinvasive_tissue_morphology = Slot(uri=CCDH.preinvasive_tissue_morphology, name="specimen__preinvasive_tissue_morphology", curie=CCDH.curie('preinvasive_tissue_morphology'),
                   model_uri=CCDH.specimen__preinvasive_tissue_morphology, domain=None, range=Optional[str])
...
slots.specimen__morphology_pathologically_confirmed = Slot(uri=CCDH.morphology_pathologically_confirmed, name="specimen__morphology_pathologically_confirmed", curie=CCDH.curie('morphology_pathologically_confirmed'),
                   model_uri=CCDH.specimen__morphology_pathologically_confirmed, domain=None, range=Optional[str])
...
slots.specimen__morphology_assessor_role = Slot(uri=CCDH.morphology_assessor_role, name="specimen__morphology_assessor_role", curie=CCDH.curie('morphology_assessor_role'),
                   model_uri=CCDH.specimen__morphology_assessor_role, domain=None, range=Optional[str])
...
slots.specimen__morphlogy_assessment_method = Slot(uri=CCDH.morphlogy_assessment_method, name="specimen__morphlogy_assessment_method", curie=CCDH.curie('morphlogy_assessment_method'),
                   model_uri=CCDH.specimen__morphlogy_assessment_method, domain=None, range=Optional[str])
...
slots.specimen__degree_of_dysplasia = Slot(uri=CCDH.degree_of_dysplasia, name="specimen__degree_of_dysplasia", curie=CCDH.curie('degree_of_dysplasia'),
                   model_uri=CCDH.specimen__degree_of_dysplasia, domain=None, range=Optional[str])
...
slots.specimen__dysplasia_fraction = Slot(uri=CCDH.dysplasia_fraction, name="specimen__dysplasia_fraction", curie=CCDH.curie('dysplasia_fraction'),
                   model_uri=CCDH.specimen__dysplasia_fraction, domain=None, range=Optional[str])
...
slots.specimen__related_document = Slot(uri=CCDH.related_document, name="specimen__related_document", curie=CCDH.curie('related_document'),
                   model_uri=CCDH.specimen__related_document, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimen__section_location = Slot(uri=CCDH.section_location, name="specimen__section_location", curie=CCDH.curie('section_location'),
                   model_uri=CCDH.specimen__section_location, domain=None, range=Optional[str])
...
slots.specimen__derived_product = Slot(uri=CCDH.derived_product, name="specimen__derived_product", curie=CCDH.curie('derived_product'),
                   model_uri=CCDH.specimen__derived_product, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenCreationActivity__activity_type = Slot(uri=CCDH.activity_type, name="specimenCreationActivity__activity_type", curie=CCDH.curie('activity_type'),
                   model_uri=CCDH.specimenCreationActivity__activity_type, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__date_started = Slot(uri=CCDH.date_started, name="specimenCreationActivity__date_started", curie=CCDH.curie('date_started'),
                   model_uri=CCDH.specimenCreationActivity__date_started, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__date_ended = Slot(uri=CCDH.date_ended, name="specimenCreationActivity__date_ended", curie=CCDH.curie('date_ended'),
                   model_uri=CCDH.specimenCreationActivity__date_ended, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__performed_by = Slot(uri=CCDH.performed_by, name="specimenCreationActivity__performed_by", curie=CCDH.curie('performed_by'),
                   model_uri=CCDH.specimenCreationActivity__performed_by, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__collection_method_type = Slot(uri=CCDH.collection_method_type, name="specimenCreationActivity__collection_method_type", curie=CCDH.curie('collection_method_type'),
                   model_uri=CCDH.specimenCreationActivity__collection_method_type, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__derivation_method_type = Slot(uri=CCDH.derivation_method_type, name="specimenCreationActivity__derivation_method_type", curie=CCDH.curie('derivation_method_type'),
                   model_uri=CCDH.specimenCreationActivity__derivation_method_type, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__additive = Slot(uri=CCDH.additive, name="specimenCreationActivity__additive", curie=CCDH.curie('additive'),
                   model_uri=CCDH.specimenCreationActivity__additive, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenCreationActivity__collection_site = Slot(uri=CCDH.collection_site, name="specimenCreationActivity__collection_site", curie=CCDH.curie('collection_site'),
                   model_uri=CCDH.specimenCreationActivity__collection_site, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__input_specimen = Slot(uri=CCDH.input_specimen, name="specimenCreationActivity__input_specimen", curie=CCDH.curie('input_specimen'),
                   model_uri=CCDH.specimenCreationActivity__input_specimen, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenCreationActivity__quantity_collected = Slot(uri=CCDH.quantity_collected, name="specimenCreationActivity__quantity_collected", curie=CCDH.curie('quantity_collected'),
                   model_uri=CCDH.specimenCreationActivity__quantity_collected, domain=None, range=Optional[str])
...
slots.specimenCreationActivity__execution_condition = Slot(uri=CCDH.execution_condition, name="specimenCreationActivity__execution_condition", curie=CCDH.curie('execution_condition'),
                   model_uri=CCDH.specimenCreationActivity__execution_condition, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenCreationActivity__specimen_order = Slot(uri=CCDH.specimen_order, name="specimenCreationActivity__specimen_order", curie=CCDH.curie('specimen_order'),
                   model_uri=CCDH.specimenCreationActivity__specimen_order, domain=None, range=Optional[str])
...
slots.specimenProcessingActivity__activity_type = Slot(uri=CCDH.activity_type, name="specimenProcessingActivity__activity_type", curie=CCDH.curie('activity_type'),
                   model_uri=CCDH.specimenProcessingActivity__activity_type, domain=None, range=Optional[str])
...
slots.specimenProcessingActivity__date_started = Slot(uri=CCDH.date_started, name="specimenProcessingActivity__date_started", curie=CCDH.curie('date_started'),
                   model_uri=CCDH.specimenProcessingActivity__date_started, domain=None, range=Optional[str])
...
slots.specimenProcessingActivity__date_ended = Slot(uri=CCDH.date_ended, name="specimenProcessingActivity__date_ended", curie=CCDH.curie('date_ended'),
                   model_uri=CCDH.specimenProcessingActivity__date_ended, domain=None, range=Optional[str])
...
slots.specimenProcessingActivity__duration = Slot(uri=CCDH.duration, name="specimenProcessingActivity__duration", curie=CCDH.curie('duration'),
                   model_uri=CCDH.specimenProcessingActivity__duration, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenProcessingActivity__performed_by = Slot(uri=CCDH.performed_by, name="specimenProcessingActivity__performed_by", curie=CCDH.curie('performed_by'),
                   model_uri=CCDH.specimenProcessingActivity__performed_by, domain=None, range=Optional[str])
...
slots.specimenProcessingActivity__method_type = Slot(uri=CCDH.method_type, name="specimenProcessingActivity__method_type", curie=CCDH.curie('method_type'),
                   model_uri=CCDH.specimenProcessingActivity__method_type, domain=None, range=Optional[str])
...
slots.specimenProcessingActivity__additive = Slot(uri=CCDH.additive, name="specimenProcessingActivity__additive", curie=CCDH.curie('additive'),
                   model_uri=CCDH.specimenProcessingActivity__additive, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenProcessingActivity__device = Slot(uri=CCDH.device, name="specimenProcessingActivity__device", curie=CCDH.curie('device'),
                   model_uri=CCDH.specimenProcessingActivity__device, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenProcessingActivity__executionConditions = Slot(uri=CCDH.executionConditions, name="specimenProcessingActivity__executionConditions", curie=CCDH.curie('executionConditions'),
                   model_uri=CCDH.specimenProcessingActivity__executionConditions, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenStorageActivity__date_started = Slot(uri=CCDH.date_started, name="specimenStorageActivity__date_started", curie=CCDH.curie('date_started'),
                   model_uri=CCDH.specimenStorageActivity__date_started, domain=None, range=Optional[str])
...
slots.specimenStorageActivity__date_ended = Slot(uri=CCDH.date_ended, name="specimenStorageActivity__date_ended", curie=CCDH.curie('date_ended'),
                   model_uri=CCDH.specimenStorageActivity__date_ended, domain=None, range=Optional[str])
...
slots.specimenStorageActivity__method_type = Slot(uri=CCDH.method_type, name="specimenStorageActivity__method_type", curie=CCDH.curie('method_type'),
                   model_uri=CCDH.specimenStorageActivity__method_type, domain=None, range=Optional[str])
...
slots.specimenStorageActivity__container = Slot(uri=CCDH.container, name="specimenStorageActivity__container", curie=CCDH.curie('container'),
                   model_uri=CCDH.specimenStorageActivity__container, domain=None, range=Optional[Union[str, List[str]]])
...
slots.specimenTransportActivity__date_started = Slot(uri=CCDH.date_started, name="specimenTransportActivity__date_started", curie=CCDH.curie('date_started'),
                   model_uri=CCDH.specimenTransportActivity__date_started, domain=None, range=Optional[str])
...
slots.specimenTransportActivity__date_ended = Slot(uri=CCDH.date_ended, name="specimenTransportActivity__date_ended", curie=CCDH.curie('date_ended'),
                   model_uri=CCDH.specimenTransportActivity__date_ended, domain=None, range=Optional[str])
...
slots.specimenTransportActivity__transport_destination = Slot(uri=CCDH.transport_destination, name="specimenTransportActivity__transport_destination", curie=CCDH.curie('transport_destination'),
                   model_uri=CCDH.specimenTransportActivity__transport_destination, domain=None, range=Optional[str])
...
slots.timePoint__indexEventType = Slot(uri=CCDH.indexEventType, name="timePoint__indexEventType", curie=CCDH.curie('indexEventType'),
                   model_uri=CCDH.timePoint__indexEventType, domain=None, range=Optional[str])
...
slots.timePoint__offsetFromIndex_indexOffset = Slot(uri=CCDH.offsetFromIndex_indexOffset, name="timePoint__offsetFromIndex_indexOffset", curie=CCDH.curie('offsetFromIndex_indexOffset'),
                   model_uri=CCDH.timePoint__offsetFromIndex_indexOffset, domain=None, range=Optional[str])
...
slots.timePeriod__periodStart_start = Slot(uri=CCDH.periodStart_start, name="timePeriod__periodStart_start", curie=CCDH.curie('periodStart_start'),
                   model_uri=CCDH.timePeriod__periodStart_start, domain=None, range=Optional[str])
...
slots.timePeriod__periodEnd_end = Slot(uri=CCDH.periodEnd_end, name="timePeriod__periodEnd_end", curie=CCDH.curie('periodEnd_end'),
                   model_uri=CCDH.timePeriod__periodEnd_end, domain=None, range=Optional[str])
